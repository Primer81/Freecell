...
/**
 * This is the interface of the Freecell cs3500.singleMoveModel.model. It is parameterized over the
...
public interface FreecellOperations<K> {
  ...
  /**
   * Deal a new game of singleMoveModel with the given deck, with or without shuffling
