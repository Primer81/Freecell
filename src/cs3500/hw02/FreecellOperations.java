...
/**
 * This is the interface of the Freecell cs3500.hw02.model. It is parameterized over the
...
public interface FreecellOperations<K> {
  ...
  /**
   * Deal a new game of hw02 with the given deck, with or without shuffling
